...
<html>
    <head>
        ...
        <title>Dados Gerararquivo</title>
    </head>
    ...
    <body style="background-image:url(${createLinkTo(dir:'images/view/show/backgroundPagina',file:'backgroundPagina.jpg')});background-repeat:no-repeat;background-size:cover;">
        <div class="card">
		  ...
		  <span class="card-title"><b>D</b>ados <b>Gerararquivo</b></span>
		</div>		
        <div class="body">
                ...
                <table class="striped centered">
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:gerararquivo, field:'id')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="base" action="show" id="${gerararquivo?.base?.id}">${gerararquivo?.base?.encodeAsHTML()}</g:link></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name">Caminho Arquivo:</td>
                            
                            <td valign="top" class="value">${fieldValue(bean:gerararquivo, field:'caminhoArquivo')}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name">Nome Arquivo:</td>
                            
                            <td valign="top" class="value">${fieldValue(bean:gerararquivo, field:'nomeArquivo')}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name">Tipo Arquivo:</td>
                            
                            <td valign="top" class="value">${fieldValue(bean:gerararquivo, field:'tipoArquivo')}</td>
            ...
            <div class="buttons" align="center"><br>
                <g:form>
                    <input type="hidden" name="id" value="${gerararquivo?.id}" />
